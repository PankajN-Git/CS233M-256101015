# CS553: Digital Logic and Computer Architecture — Assignment 2: Custom Pipelined CPU (RVX10p)

This directory contains my work for Custom Pipelined CPU (RVX10p). Below you will find the purpose of the assignment, what's included, how to run the simulation, and links to the waveform and full project report.
...
- Project report: RVX10p/Docs/REPORT.md
  - GitHub permalink: https://github.com/PankajN-Git/CS233M-256101015/blob/main/RVX10p/Docs/REPORT.md
- Waveform image in Docs: RVX10p/Docs/wave.png
  - GitHub permalink: https://github.com/PankajN-Git/CS233M-256101015/blob/main/RVX10p/Docs/wave.png
- Sources:
  - `src/datapath.sv`
  - `src/controller.sv`
...
A comprehensive project report and the waveform image are stored under the Docs directory inside this RVX10p folder. You can view them on GitHub or open locally:

- REPORT: RVX10p/Docs/REPORT.md
  - Use the GitHub link above or open the file locally.
- Waveform image: RVX10p/Docs/wave.png
